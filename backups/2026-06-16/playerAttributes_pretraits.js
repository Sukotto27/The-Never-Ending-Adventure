...
const gameTraits = {
  ...
  // ── Single traits (no paired opposite) ──────────────────────────────────────
  'Strong-Willed': {
    description:  'Refuses to yield to hardship or pressure.',
    displayBonus: '+2 to resist fear, curses, and manipulation',
    willBonus: +2,
  },
  Evil: {
  ...
  Courageous: {
    ...
    displayBonus: '+2 to courage and combat checks',
    courageBonus: +2,
  },
  Sneaky: {
  ...
  Witty: {
    description:  'Quick with a sharp remark.',
  ...
  Determined: {
    ...
    displayBonus: '+2 to Survival in desperate moments',
    survivalBonus: +2,
  },
  Charming: {
  ...
  Bloodthirsty: {
    ...
    displayBonus: '+2 to attack rolls in combat; −2 to social rolls',
    attackBonus: +2, socialPenalty: -2,
  },
  Clever: {
  ...
  Inquisitive: {
    ...
    displayBonus: '+2 to Decrypting; +1 to knowledge and lore checks',
    intellectBonus: +2,
  },
  Observant: {
