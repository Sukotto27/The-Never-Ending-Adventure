...
const TRAIT_UNLOCK_CONDITIONS = [
  ...
  { trait: 'Courageous',     test: (c)    => (c.nearDeaths || 0) >= 2 && (c.heroicTones || 0) >= 10 },
  { trait: 'Sneaky',         test: (c, p) => (p.skills?.Stealth?.level || 0) >= 15 },
  { trait: 'Witty',          test: (c)    => (c.persuasionSuccesses || 0) >= 10 && (c.heroicTones || 0) >= 5 },
  { trait: 'Cautious',       test: (c)    => (c.persuasionFails || 0) < 5 && (c.npcInteractions || 0) >= 20 },
  ...
  { trait: 'Bloodthirsty',   test: (c)    => (c.aggressiveTones || 0) >= 35 },
  ...
  { trait: 'Friendly',       test: (c)    => (c.persuasionSuccesses || 0) >= 30 && (c.npcInteractions || 0) >= 30 },
  ...
  { trait: 'Pacifist',      test: (c, p) => (c.heroicTones || 0) >= 30 && (p.skills?.Healing?.level || 0) >= 20 },
  ...
  { trait: 'Aloof',         test: (c, p) => (c.npcInteractions || 0) < 5 && (p.journal?.locations?.length || 0) >= 20 },
