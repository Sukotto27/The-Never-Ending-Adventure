...
const gameTraits = {
  ...
  Courageous: {
    ...
    displayBonus: '+2 to courage and combat checks; NPCs see you as bold',
    opposite:     'Faint-Hearted',
    courageBonus: +2, socialBonus: +1,
  },
  'Faint-Hearted': {
    description:  'Hesitates when decisive action is needed.',
    displayBonus: '−2 to courage and combat checks; NPCs see you as indecisive',
    opposite:     'Courageous',
    couragePenalty: -2, socialPenalty: -1,
  },
  ...
  Cautious: {
    description:  'Proceeds carefully and avoids rash decisions.',
    displayBonus: '+1 to Survival; +1 to Tracking; less likely to trigger traps',
    opposite:     'Heedless',
    survivalBonus: +1, intellectBonus: +1,
  },
  Heedless: {
    description:  'Acts without checking surroundings or consequences.',
    displayBonus: '−2 to Survival; −1 to Tracking; more likely to trigger hazards',
    opposite:     'Cautious',
    survivalPenalty: -2, intellectPenalty: -1,
  },
  ...
  Bloodthirsty: {
    description:  'Craves combat and violence.',
    displayBonus: '+2 to attack rolls; −2 to social rolls',
    opposite:     'Pacifist',
    attackBonus: +2, socialPenalty: -2,
  },
  Pacifist: {
    description:  'Opposes violence; seeks peaceful resolutions.',
    displayBonus: '−2 to attack rolls; +1 to social with peaceful NPCs; +1 to Healing',
    opposite:     'Bloodthirsty',
    attackPenalty: -2, socialBonus: +1, healBonus: +1,
  },
  ...
  Friendly: {
    description:  'Immediately likeable and easy to talk to.',
    displayBonus: '+3 to social rolls; NPCs open up quickly',
    opposite:     'Aloof',
    socialBonus: +3,
  },
  Aloof: {
    description:  'Keeps others at a distance.',
    displayBonus: '−3 to social rolls; NPCs do not open up easily',
    opposite:     'Friendly',
    socialPenalty: -3,
  },
